...
| Mulberry32 PRNG for allocation | Seeded randomness, reproducible results | Good |
| Server/client composition pattern | SSR data fetching, client interactivity | Good |
...
- Gap closure for OUT-06 (statistics on output page)
- Print styles with @custom-variant for Tailwind v4
